...
local _padding = require "ftree.renderer.padding"
local _help = require "ftree.renderer.help"
local _icons = require "ftree.renderer.icons"
local git = require "ftree.renderer.git"
...
function M.draw()
    ...
    local show_arrows = not M.config.indent_markers.enable and icon_state.show_folder_icon and icon_state.show_folder_arrows
...
function M.setup(opts)
  ...
  require("ftree.renderer.padding").setup(opts)
end
