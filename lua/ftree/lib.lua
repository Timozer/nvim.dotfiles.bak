...
function M.get_node_at_cursor()
  ...
  if view.is_help_ui() then
    local help_lines = require("ftree.renderer.help").compute_lines()
...
local function handle_buf_cwd(cwd)
  ...
  if respect_buf_cwd == 1 and cwd ~= core.get_explorer().cwd then
    require("ftree.actions.change-dir").fn(cwd)
  end
end
...
-- @deprecated: use ftree.actions.collapse-all.fn
M.collapse_all = require("ftree.actions.collapse-all").fn
-- @deprecated: use ftree.actions.reloaders.reload_explorer
M.refresh_tree = require("ftree.actions.reloaders").reload_explorer
-- @deprecated: use ftree.actions.reloaders.reload_git
M.reload_git = require("ftree.actions.reloaders").reload_git
-- @deprecated: use ftree.actions.find-file.fn
M.set_index_and_redraw = require("ftree.actions.find-file").fn
